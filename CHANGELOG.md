...
* fix: kitty image placements with per-cell source crops rendering the same fragment (https://github.com/zellij-org/zellij/pull/5623)
...
* fix: occasional high resource utilization and sluggishness on machines with tens of thousands of concurrent processes (https://github.com/zellij-org/zellij/pull/5324)
...
* fix: allow specifying "0%" coordinates when opening panes with "zellij run --floating" (https://github.com/zellij-org/zellij/pull/4609)
...
* fix: don't serialize when only ui elements present and provide post command discovery hook (https://github.com/zellij-org/zellij/pull/4276)
...
* fix(startup): do not parse resurrectable sessions on startup (https://github.com/zellij-org/zellij/pull/3505)
...
* fix: error loading non-existent themes directory (https://github.com/zellij-org/zellij/pull/2411)
