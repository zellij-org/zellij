...
impl Page {
    ...
    pub fn tip_1(link_executable: Rc<RefCell<String>>) -> Self {
        Page::new()
            .main_screen()
            .with_title(Text::from("Zellij Tip #1").color_range(0, ..))
            .with_paragraph(vec![
                ComponentLine::new(vec![
                    ActiveComponent::new(TextOrCustomRender::Text(
                            Text::from("Check out the Zellij screencasts/tutorials to learn how to better take advantage")
                    ))
                ]),
                ComponentLine::new(vec![
                    ActiveComponent::new(TextOrCustomRender::Text(
                            Text::from("of all the Zellij features. Learn about basic usage, layouts, sessions and more!")
                    ))
                ])
            ])
            .with_paragraph(vec![ComponentLine::new(vec![
                ActiveComponent::new(TextOrCustomRender::Text(Text::from("Follow this link: ").color_range(2, ..))),
                ActiveComponent::new(TextOrCustomRender::Text(Text::from("https://zellij.dev/screencasts")))
    ...
    pub fn tip_2(link_executable: Rc<RefCell<String>>, base_mode: Rc<RefCell<InputMode>>) -> Self {
        Page::new()
            .main_screen()
            .with_title(Text::from("Zellij Tip #2").color_range(0, ..))
            .with_paragraph(vec![
                ComponentLine::new(vec![
                    ActiveComponent::new(TextOrCustomRender::Text(
                            Text::from("You can open the terminal contents in your $EDITOR, allowing you to search")
                                .color_range(2, 43..=49)
                    ))
                ]),
                ComponentLine::new(vec![
                    ActiveComponent::new(TextOrCustomRender::Text(
                            Text::from("through them, copy to your clipboard or even save them for later.")
                    ))
                ])
            ])
            .with_paragraph(vec![ComponentLine::new(vec![
                match *base_mode.borrow() {
                    InputMode::Locked => {
                        ActiveComponent::new(TextOrCustomRender::Text(
                            Text::from("While focused on a terminal pane: Ctrl g + s + e")
                                .color_range(0, 34..=39)
                    ...
                    _ => {
                        ActiveComponent::new(TextOrCustomRender::Text(
                            Text::from("While focused on a terminal pane: Ctrl s + e")
                                .color_range(0, 34..=39)
    ...
    pub fn tip_3(link_executable: Rc<RefCell<String>>) -> Self {
        Page::new()
            .main_screen()
            .with_title(Text::from("Zellij Tip #3").color_range(0, ..))
            .with_paragraph(vec![
                ComponentLine::new(vec![ActiveComponent::new(TextOrCustomRender::Text(
                    Text::from("Want to make your floating pane bigger?"),
                ))]),
                ComponentLine::new(vec![ActiveComponent::new(TextOrCustomRender::Text(
                    Text::from(
    ...
    fn tip_4(link_executable: Rc<RefCell<String>>, base_mode: Rc<RefCell<InputMode>>) -> Page {
        Page::new()
            .main_screen()
            .with_title(Text::from("Zellij tip #4").color_range(0, ..))
            .with_paragraph(vec![
                ComponentLine::new(vec![ActiveComponent::new(TextOrCustomRender::Text(
                    Text::from("It's possible to \"pin\" a floating pane so that it will always"),
                ))]),
                ComponentLine::new(vec![ActiveComponent::new(TextOrCustomRender::Text(
                    Text::from("be visible even if floating panes are hidden."),
                ))]),
            ])
            .with_bulletin_list(
                BulletinList::new(
                    Text::from(format!("Floating panes can be \"pinned\": ")).color_range(2, ..),
                )
                .with_items(vec![
                    ActiveComponent::new(TextOrCustomRender::Text(
                        Text::from("With a mouse click on their top right corner")
                            .color_range(3, 7..=17),
                    )),
                    ActiveComponent::new(TextOrCustomRender::Text(match *base_mode.borrow() {
                        InputMode::Locked => Text::from("With Ctrl g + p + i")
                            .color_range(3, 5..=10)
                            .color_range(3, 14..15)
                            .color_range(3, 18..19),
                        _ => Text::from("With Ctrl p + i")
                            .color_range(3, 5..=10)
                            .color_range(3, 14..15),
                    })),
                ]),
            ...
            .with_paragraph(vec![
                ComponentLine::new(vec![ActiveComponent::new(TextOrCustomRender::Text(
                    Text::from("A great use case for these is to tail log files or to show"),
                ))]),
                ComponentLine::new(vec![ActiveComponent::new(TextOrCustomRender::Text(
                    Text::from("real-time compiler output while working in other panes."),
                ))]),
            ])
            .with_paragraph(vec![ComponentLine::new(vec![
                ActiveComponent::new(TextOrCustomRender::Text(support_the_developer_text())),
    ...
    pub fn tip_5(link_executable: Rc<RefCell<String>>) -> Page {
        Page::new()
            .main_screen()
            .with_title(Text::from("Zellij Tip #5").color_range(0, ..))
            .with_paragraph(vec![
                ComponentLine::new(vec![
                    ActiveComponent::new(TextOrCustomRender::Text(Text::from("Panes can be resized into stacks to be managed easier."))),
                ]),
            ])
            .with_bulletin_list(BulletinList::new(Text::from("To try it out:").color_range(2, ..))
                .with_items(vec![
                    ActiveComponent::new(TextOrCustomRender::Text(
                            Text::from("Hide this pane with Alt f (you can bring it back with Alt f again)")
                                .color_range(3, 20..=24)
                                .color_range(3, 54..=58)
                    )),
                    ActiveComponent::new(TextOrCustomRender::Text(
                            Text::from("Open 4-5 panes with Alt n")
                                .color_range(3, 20..=24)
                    )),
                    ActiveComponent::new(TextOrCustomRender::Text(
                            Text::from("Press Alt + until you reach full screen")
                                .color_range(3, 6..=10)
                    )),
                    ActiveComponent::new(TextOrCustomRender::Text(
                            Text::from("Press Alt - until you are back at the original state")
                                .color_range(3, 6..=10)
                    )),
                    ActiveComponent::new(TextOrCustomRender::Text(
                            Text::from("You can always snap back to the built-in swap layouts with Alt <[]>")
                                .color_range(3, 59..=61)
                                .color_range(3, 64..=65)
                    )),
                ])
            ...
            .with_paragraph(vec![
                ComponentLine::new(vec![
                    ActiveComponent::new(TextOrCustomRender::Text(
                            Text::from("To disable this behavior, add stacked_resize false to the Zellij Configuration")
                                .color_range(3, 30..=49)
                    )),
                ])
            ])
            .with_paragraph(vec![
                ComponentLine::new(vec![
                    ActiveComponent::new(TextOrCustomRender::Text(
                        Text::from("For more details, see: ")
                            .color_range(2, ..)
                    )),
                    ActiveComponent::new(TextOrCustomRender::Text(Text::from("https://zellij.dev/tutorials/stacked-resize")))
    ...
    pub fn tip_6(link_executable: Rc<RefCell<String>>, base_mode: Rc<RefCell<InputMode>>) -> Page {
        Page::new()
            .main_screen()
            .with_title(Text::from("Zellij Tip #6").color_range(0, ..))
            .with_paragraph(vec![
                ComponentLine::new(vec![
                    ActiveComponent::new(TextOrCustomRender::Text(Text::from("Are the Zellij keybindings colliding with other applications for you?")))
                ]),
            ])
            .with_bulletin_list(BulletinList::new(Text::from("Check out the non-colliding keybindings preset:"))
                .with_items(vec![
                    ActiveComponent::new(TextOrCustomRender::Text(
                            match *base_mode.borrow() {
                                InputMode::Locked => {
                                    Text::from("Open the Zellij configuration with Ctrl g + o + c")
                                        .color_range(3, 35..=40)
                                        .color_indices(3, vec![44, 48])
                                },
                                _ => {
                                    Text::from("Open the Zellij configuration with Ctrl o + c")
                                        .color_range(3, 35..=40)
                    ...
                    ActiveComponent::new(TextOrCustomRender::Text(
                            Text::from("Press TAB to go to Change Mode Behavior")
                                .color_range(3, 6..=9)
                    )),
                    ActiveComponent::new(TextOrCustomRender::Text(
                            Text::from("Select non-colliding temporarily with ENTER or permanently with Ctrl a")
                                .color_range(3, 38..=42)
                                .color_range(3, 64..=69)
                    )),
                ])
            ...
            .with_paragraph(vec![
                ComponentLine::new(vec![
                    ...
                    ActiveComponent::new(TextOrCustomRender::Text(Text::from("https://zellij.dev/tutorials/colliding-keybindings")))
    ...
    pub fn tip_7(link_executable: Rc<RefCell<String>>) -> Page {
        Page::new()
            .main_screen()
            .with_title(Text::from("Zellij Tip #7").color_range(0, ..))
            ...
            .with_paragraph(vec![
                ComponentLine::new(vec![
                    ActiveComponent::new(TextOrCustomRender::Text(
                        Text::from("Check out the built-in themes: ").color_range(2, ..),
                    )),
                ...
                ComponentLine::new(vec![
                    ActiveComponent::new(TextOrCustomRender::Text(
                        Text::from("Or create your own theme: ").color_range(2, ..),
                    )),
                    ActiveComponent::new(TextOrCustomRender::Text(Text::from(
    ...
    pub fn tip_8(link_executable: Rc<RefCell<String>>) -> Page {
        Page::new()
            .main_screen()
            .with_title(Text::from("Zellij Tip #8").color_range(0, ..))
            .with_paragraph(vec![
                ComponentLine::new(vec![
                    ActiveComponent::new(TextOrCustomRender::Text(
                        Text::from("If you change the pane focus with Alt + <←↓↑→> or Alt + <hjkl> beyond the")
                            .color_range(0, 34..=36)
                            .color_range(2, 40..=45)
                            .color_range(0, 50..=52)
                            .color_range(2, 56..=61)
                ...
                ComponentLine::new(vec![
                    ActiveComponent::new(TextOrCustomRender::Text(Text::from("right or left side of the screen, the next or previous tab will be focused.")))
                ]),
            ])
            .with_paragraph(vec![ComponentLine::new(vec![
                ActiveComponent::new(TextOrCustomRender::Text(support_the_developer_text())),
    ...
    pub fn tip_9(link_executable: Rc<RefCell<String>>) -> Page {
        Page::new()
            .main_screen()
            .with_title(Text::from("Zellij Tip #9").color_range(0, ..))
            .with_paragraph(vec![
                ComponentLine::new(vec![
                    ActiveComponent::new(TextOrCustomRender::Text(
                        Text::from("For plugins, integrations and tutorials created by the community, check out the")
                    ))
                ]),
                ComponentLine::new(vec![
                    ActiveComponent::new(TextOrCustomRender::Text(
                        Text::from("Awesome-zellij repository: ")
                            .color_range(2, ..=39)
                    )),
                    ActiveComponent::new(TextOrCustomRender::Text(Text::from("https://github.com/zellij-org/awesome-zellij")))
                        .with_hover(TextOrCustomRender::CustomRender(
            ...
            .with_paragraph(vec![
                ComponentLine::new(vec![
                    ActiveComponent::new(TextOrCustomRender::Text(
                        Text::from("For community and support:")
                            .color_range(2, ..)
                    ))
                ]),
                ComponentLine::new(vec![
                    ActiveComponent::new(TextOrCustomRender::Text(Text::from("Discord: "))),
                    ActiveComponent::new(TextOrCustomRender::Text(Text::from("https://discord.com/invite/CrUAFH3")))
                        .with_hover(TextOrCustomRender::CustomRender(
                ...
                ComponentLine::new(vec![
                    ActiveComponent::new(TextOrCustomRender::Text(Text::from("Matrix: "))),
                    ActiveComponent::new(TextOrCustomRender::Text(Text::from("https://matrix.to/#/#zellij_general:matrix.org")))
                        .with_hover(TextOrCustomRender::CustomRender(
    ...
    pub fn tip_10(link_executable: Rc<RefCell<String>>, base_mode: Rc<RefCell<InputMode>>) -> Page {
        Page::new()
            .main_screen()
            .with_title(Text::from("Zellij Tip #10").color_range(0, ..))
            .with_bulletin_list(
                BulletinList::new(
                    Text::from("The Zellij session-manager can:").color_range(2, 11..=25),
                )
                .with_items(vec![
                    ActiveComponent::new(TextOrCustomRender::Text(Text::from(
                        "Create new sessions",
            ...
            .with_paragraph(vec![ComponentLine::new(vec![ActiveComponent::new(
                TextOrCustomRender::Text(
                    Text::from("You can also use it as a welcome screen with: zellij -l welcome")
                        .color_range(0, 46..=62),
                ),
            )])])
            .with_paragraph(vec![ComponentLine::new(vec![
    ...
    pub fn tip_11(link_executable: Rc<RefCell<String>>) -> Page {
        Page::new()
            .main_screen()
            .with_title(Text::from("Zellij Tip #11").color_range(0, ..))
            .with_paragraph(vec![
                ComponentLine::new(vec![
                    ActiveComponent::new(TextOrCustomRender::Text(
                        Text::from("You can change the arrangement of panes on screen with Alt + []")
                            .color_range(0, 55..=57)
                            .color_range(2, 61..=62)
                    )),
                ]),
                ComponentLine::new(vec![
                    ActiveComponent::new(TextOrCustomRender::Text(
                        Text::from("This works with tiled or floating panes, depending which is visible.")
                    ))
                ])
            ])
            .with_paragraph(vec![
                ComponentLine::new(vec![
                    ActiveComponent::new(TextOrCustomRender::Text(
                        Text::from("Resizing or splitting a pane breaks out of this arrangement. It is then possible")
                    )),
                ]),
                ComponentLine::new(vec![
                    ActiveComponent::new(TextOrCustomRender::Text(
                        Text::from("to snap back by pressing Alt + [] once more. This status can be seen")
                            .color_range(0, 25..=27)
                            .color_range(2, 31..=32)
                    )),
                ]),
                ComponentLine::new(vec![
                    ActiveComponent::new(TextOrCustomRender::Text(
                        Text::from("on the top right corner of the screen.")
                    )),
                ]),
            ])
            .with_paragraph(vec![ComponentLine::new(vec![
    ...
    pub fn tip_12(link_executable: Rc<RefCell<String>>, base_mode: Rc<RefCell<InputMode>>) -> Page {
        Page::new()
            .main_screen()
            .with_title(Text::from("Zellij Tip #12").color_range(0, ..))
            .with_paragraph(vec![
                ComponentLine::new(vec![
                    ActiveComponent::new(TextOrCustomRender::Text(
                        Text::from("Zellij plugins can be loaded, reloaded and tracked from the plugin-manager.")
                    )),
                ]),
                ComponentLine::new(vec![
                    ActiveComponent::new(TextOrCustomRender::Text(
            ...
            .with_paragraph(vec![ComponentLine::new(vec![
                ActiveComponent::new(TextOrCustomRender::Text(Text::from("To learn more about plugins: ").color_range(2, ..))),
                ActiveComponent::new(TextOrCustomRender::Text(Text::from("https://zellij.dev/documentation/plugins")))
                    .with_hover(TextOrCustomRender::CustomRender(
