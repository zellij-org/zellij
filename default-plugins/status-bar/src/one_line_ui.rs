...
fn get_keys_and_hints(mi: &ModeInfo) -> Vec<(String, String, Vec<KeyWithModifier>)> {
    ...
    if mi.mode == IM::Pane { vec![
        ...
        vec![
        (s("New"), s("New"), single_action_key(&km, &[A::NewTab(None, None, None, vec![], None, None, None), TO_NORMAL])),
        ...
        (s("New tab"), s("New"), action_key(&km, &[A::NewTab(None, None, None, vec![], None, None, None), TO_NORMAL])),
