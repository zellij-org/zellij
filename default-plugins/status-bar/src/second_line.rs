...
fn get_keys_and_hints(mi: &ModeInfo) -> Vec<(String, String, Vec<KeyWithModifier>)> {
    ...
    if mi.mode == IM::Pane { vec![
        (s("New"), s("New"), action_key(&km, &[A::NewPane(None, None, false, false), TO_NORMAL])),
        (s("FourWay"), s("FourWay"), action_key(&km, &[A::NewPane(None, None, false, true), TO_NORMAL])),
            ...
            keybinds: vec![(
                ...
                vec![
                    ...
                    (
                        ...
                        vec![Action::NewPane(None, None, false, false), TO_NORMAL],
                    ),
                    (
                        KeyWithModifier::new(BareKey::Char('+')),
                        vec![Action::NewPane(None, None, false, true), TO_NORMAL],
                    ),
                    (
