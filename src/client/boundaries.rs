...
fn combine_symbols(current_symbol: BoundarySymbol, next_symbol: BoundarySymbol) -> Option<BoundarySymbol> {
...
fn find_next_symbol(first_symbol: BoundarySymbol, second_symbol: BoundarySymbol) -> Option<BoundarySymbol> {
