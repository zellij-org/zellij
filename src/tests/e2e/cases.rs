...
use crate::tests::utils::commands::{
    PANE_MODE, QUIT, SCROLL_MODE, SCROLL_UP_IN_SCROLL_MODE,
    SPLIT_RIGHT_IN_PANE_MODE, TOGGLE_ACTIVE_TERMINAL_FULLSCREEN_IN_PANE_MODE, ENTER,
    TAB_MODE, NEW_TAB_IN_TAB_MODE, CLOSE_PANE_IN_PANE_MODE, RESIZE_MODE, RESIZE_LEFT_IN_RESIZE_MODE, LOCK_MODE,
