...
use crate::tests::utils::commands::{
    COMMAND_TOGGLE, QUIT, PANE_MODE, SPAWN_TERMINAL_IN_PANE_MODE, SPLIT_DOWN_IN_PANE_MODE,
    SPLIT_RIGHT_IN_PANE_MODE, SCROLL_MODE, SCROLL_UP_IN_SCROLL_MODE, ESC, SCROLL_DOWN_IN_SCROLL_MODE,
