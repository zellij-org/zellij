...
use crate::tests::{
    ...
    start,
    utils::{
        commands::{normal_mouse_report, PANE_MODE, QUIT, SPLIT_RIGHT_IN_PANE_MODE},
...
pub fn scroll_up_with_mouse() {
    ...
    fake_input_output.add_terminal_input(&[
        ...
        &normal_mouse_report(Position::new(1, 1), 64),
        &QUIT,
    ]);
    start(
...
pub fn scroll_down_with_mouse() {
    ...
    fake_input_output.add_terminal_input(&[
        ...
        &normal_mouse_report(Position::new(1, 1), 64),
        &normal_mouse_report(Position::new(1, 1), 64),
        &normal_mouse_report(Position::new(1, 1), 65),
        &QUIT,
    ]);
    start(
        Box::new(fake_input_output.clone()),
