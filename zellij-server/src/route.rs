    ...
    match action {
        ...
        Action::Write(key_with_modifier, raw_bytes, is_kitty_keyboard_protocol) => {
            senders
                ...
                .with_context(err_context)?;
            senders
                .send_to_screen(ScreenInstruction::WriteCharacter(key_with_modifier, raw_bytes, is_kitty_keyboard_protocol, client_id))
                .with_context(err_context)?;
        },
        Action::WriteChars(val) => {
            ...
            senders
                .send_to_screen(ScreenInstruction::WriteCharacter(None, val, false, client_id))
                .with_context(err_context)?;
        },
