...
pub struct Selection {
    pub start: Position,
    pub end: Position,
    pub active: bool, // used to handle moving the selection up and down
    pub last_added_word_position: Option<(Position, Position)>, // (start / end)
    pub last_added_line_index: Option<isize>,
}
...
impl Selection {
    ...
    fn get_visible_indices(&self, max: usize) -> std::ops::Range<isize> {
