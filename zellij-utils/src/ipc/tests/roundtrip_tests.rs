    ...
    test_client_roundtrip!(ClientToServerMsg::FirstClientConnected {
        cli_assets: CliAssets {
            ...
            configuration_options: Some(Options {
                ...
                osc1337_passthrough: Some(true),
                osc1337_inline_images: Some(true),
                osc1337_set_mark: Some(true),
                osc1337_current_dir: Some(true),
                osc1337_highlight_cursor_line: Some(true),
                osc1337_unicode_version: Some(true),
                osc1337_set_user_var: Some(true),
                osc1337_set_profile: Some(true),
                osc1337_set_badge_format: Some(true),
                osc1337_clear_scrollback: Some(true),
                osc1337_clipboard_copy: Some(true),
                osc1337_steal_focus: Some(true),
                osc1337_request_attention: Some(true),
                osc1337_remote_host: Some(true),
                osc1337_shell_integration_version: Some(true),
