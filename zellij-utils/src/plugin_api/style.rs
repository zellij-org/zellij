...
use super::generated_api::api::{
    style::{
        color::Payload as ProtobufColorPayload,
        ...
        RgbColorPayload as ProtobufRgbColorPayload,
    }
};
use crate::data::{Style, Palette, PaletteColor, ThemeHue};
       ...
       match color {
           PaletteColor::Rgb((red, green, blue)) => {
               ...
               Ok(ProtobufColor {
                   ...
                   payload: Some(ProtobufColorPayload::RgbColorPayload(ProtobufRgbColorPayload {
                       red, green, blue
                   }))
               })
           }
